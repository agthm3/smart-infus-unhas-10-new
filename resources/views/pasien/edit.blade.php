...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light"><a href="{{ route('daftar-pasien.index') }}">Daftar Pasien/</a></span> Edit Data
            Pasien
        </h4>
                    ...
                    <div class="card-body">
                        <form>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" placeholder="Sumanto" class="form-control" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-company">Nomor ID</label>
                                <div class="col-sm-10">
                                    <input type="text" placeholder="3225235" class="form-control" />
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" placeholder="Anti Zombie" class="form-control" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-message">Jenis Penyakit</label>
                                <div class="col-sm-10">
                                    <input type="text" placeholder="Sakit Hati" class="form-control" />
                                </div>
                            </div>
